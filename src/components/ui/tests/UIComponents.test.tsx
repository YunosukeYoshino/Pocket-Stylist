...
const TamaguiTestProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return <>{children}</>
}
...
describe('UI Components', () => {
  describe('PSButton', () => {
    it('renders correctly with default props', () => {
      const { getByText } = render(
        withProvider(<PSButton>Click me</PSButton>)
      )
  ...
  describe('PSText', () => {
    it('renders text correctly', () => {
      const { getByText } = render(
        withProvider(<PSText>Hello World</PSText>)
      )
  ...
  describe('PSIcon', () => {
    it('renders icon correctly', () => {
      const { getByText } = render(
        withProvider(<PSIcon name="heart" />)
      )
