...
const preferencesSchema = z.object({
  style: z.enum(['casual', 'formal', 'business', 'sporty', 'trendy', 'classic', 'bohemian', 'minimalist']).optional(),
  ...
  materials: z.array(z.enum(['cotton', 'wool', 'silk', 'polyester', 'linen', 'denim', 'leather', 'synthetic'])).max(10).optional(),
  occasions: z.array(z.enum(['work', 'casual', 'formal', 'party', 'date', 'travel', 'sport', 'home'])).max(10).optional(),
  seasons: z.array(z.enum(['spring', 'summer', 'fall', 'winter'])).max(4).optional(),
}).optional()
