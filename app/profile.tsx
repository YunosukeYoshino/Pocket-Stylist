    ...
    <ProtectedRoute>
      <ScrollView style={{ flex: 1 }}>
        <View flex={1} padding="$4">
          <Stack flexDirection="column" gap="$6" maxWidth={400} width="100%" alignSelf="center">
            {/* ヘッダー */}
            <Stack flexDirection="column" alignItems="center" gap="$3" marginTop="$6">
            ...
            {/* ユーザー情報 */}
            {user && (
              <View backgroundColor="$gray2" borderRadius="$6" padding="$5" width="100%">
            ...
            <Stack flexDirection="column" gap="$3" marginTop="$4">
              ...
              <Button size="$4" variant="outlined" theme="red" onPress={handleLogout}>
                ログアウト
              </Button>
            </Stack>
